...
failure counts nested under each event. The table uses the package's
normalized internal record key for counts, so REDCap projects whose record ID
field has another name still report the correct N values:
