...
total record N, event row-started N, form-complete counts, and field-complete
failure counts nested under each event. Projects whose REDCap record ID field
has another name still report the correct N values:
