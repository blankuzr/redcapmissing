...
validation step and REDCap context. It includes `validation_context` plus the
REDCap event and repeat columns used to stratify `assessed`, `passed`, `failed`,
`pass_rate`, and `fail_rate`.
