...
`redcapmissing` is an R package for working with REDCap record exports and
building missingness reports.

It is designed for REDCap data-quality workflows in R where the expectation of
a field value depends on two logic layers:
